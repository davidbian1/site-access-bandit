...
// Free time suspends every site's block rule at the DNR level, so this
// page shouldn't normally load at all while a window is active — ending
// free time is frictionless and happens from the popup, not here (see
// docs/adr/0003's Update section). If it's somehow reached anyway (a
// stale bookmark, a race right at a window's edge), REQUEST_ACCESS
// already returns granted:true for it, which the normal handleAccessResult
// path above redirects on — no special handling needed here.
